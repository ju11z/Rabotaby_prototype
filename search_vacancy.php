...
<body>
<div class="container">
    <div class="row mb-5 mt-5" style="height:120px; background-color: #7D1527;">
        <div class="col-2"></div>
        <div class="col-8" style="display:flex; flex-direction: row; justify-content: space-between; align-items: center;">
            <div class="input-block">
                <input type="text" id="search_text">
                <img src="img/icons/search_red.svg" alt="" onclick="filterVacancies()">
            </div>
        </div>
        <div class="col-2"></div>
    </div>
    <div class="row">
        <div class="col-3">
            ...
            <div class="checkbox-block">
                <input type="checkbox" class="chck" id="search_employer_name">
                <div>Искать в названии компании</div>
            </div>
            <div class="checkbox-block">
                <input type="checkbox" class="chck" id="search_vacancy_name">
                <div>Искать в названии вакансии</div>
            </div>
            <div class="checkbox-block">
                <input type="checkbox" class="chck" id="search_vacancy_descr">
                <div>Искать в описании вакансии</div>
            </div>
            <div class="delimiter bg-dark"></div>

            <div class="title-small">КАТЕГОРИЯ РАБОТЫ</div>
            <button class="btn-1" style="width:100%; background-color: #7D1527;" data-toggle="collapse" data-target="#jobCollapse">Скрыть/показать работу</button>
            ...
            <div class="delimiter bg-dark"></div>
            <button class="btn-2" style="width:100%; background-color: #7D1527;" onclick="filterVacancies()">Обновить вакансии</button>
        </div>
        <div class="col-2"></div>
        <div class="col-7">
            <div id='vacancies'>
...
<script>
    $( document ).ready(function() {
        //alert('duuude');
            $.ajax({
                ...
                data:{city_id:0, salary_id:0, employment_id:0,experience_id:0, experience_id:0,search_company_name: false, search_text:''},
    ...
    function filterVacancies(){
        search_employer_name= $("#search_employer_name").is(":checked") ? "true" : "false";//$("#checkboxId").is(":checked") ? "true" : "false";
        search_vacancy_name= $('#search_vacancy_name').is(":checked") ? "true" : "false";
        search_vacancy_descr= $('#search_vacancy_descr').is(":checked") ? "true" : "false";
        ...
        console.log(search_employer_name);
        console.log(search_text);

        $.ajax({
            type: "POST",
            url: 'print_vacancies.php',
            data:{city_id:city_id, salary_id:salary_id, employment_id:employment_id, experience_id:experience_id,job_category_id:job_category_id
                ,search_employer_name: search_employer_name, search_vacancy_name: search_vacancy_name, search_vacancy_descr: search_vacancy_descr
